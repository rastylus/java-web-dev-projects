...
//            gradeLevel =  "Freshman";
//        } else if (this.getNumberOfCredits() >= 30 && this.getNumberOfCredits() <= 59) {
//            gradeLevel = "Sophomore";
//        } else if (this.getNumberOfCredits() >= 60 && this.getNumberOfCredits() <= 89) {
//            gradeLevel = "Junior";
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sally);
        Student ryan = new Student("Ryan", 2, 92, 4.0);
